              ...
              child: Column(
                children: <Widget>[
                  ...
                  Align(
                    ...
                    child: Text(
                      "Login",
                      style: TextStyle(color: Color(0xFF121212), fontSize: 45.0, fontFamily: 'Inter', fontWeight: FontWeight.w500),
                    ),
                  ),
                        ...
                        Positioned(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                boxShadow: <BoxShadow>[
                                  BoxShadow(color: Color(0xFF000000).withAlpha(40), blurRadius: 10.0, offset: Offset(0.0, 10.0))
                                ]),
                            child: Padding(
                          ...
                          child: Container(
                            ...
                            child: FlatButton(
                              ...
                              child: Align(
                                ...
                                child: Text(
                                  'Login',
                                  style: TextStyle(color: Color(0xFFFFFFFF), fontFamily: 'Inter', fontWeight: FontWeight.w700, fontSize: 22.0),
                                ),
                              ),
                            ),
                          ),
